...
_CONVOLUTION3DLAYERPARAMS_PADDINGTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAME_LEFT', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAME_RIGHT', index=3, number=3,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_NEURALNETWORKLAYER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='convolution3d', full_name='CoreML.Specification.NeuralNetworkLayer.convolution3d', index=162,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sliceBySize', full_name='CoreML.Specification.NeuralNetworkLayer.sliceBySize', index=163,
      number=1475, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
...
_ONEHOTLAYERPARAMS = _descriptor.Descriptor(
  ...
  serialized_start=31636,
  serialized_end=31730,
)
