...
int testInvalidSigmoidCrossEntropyLossLayerInputs() {
    ...
    Specification::NetworkUpdateParameters *updateParams = nn->mutable_updateparams();
    Specification::LossLayer *lossLayer = updateParams->add_losslayers();
    lossLayer->set_name("sigmoid_cross_entropy_loss_layer");

    Specification::SigmoidCrossEntropyLossLayer *sigmoidCELossLayer = lossLayer->mutable_sigmoidcrossentropylosslayer();
    sigmoidCELossLayer->set_input("C");
    sigmoidCELossLayer->set_target("label_target");
...
int testInvalidMeanAbsoluteErrorLossLayerInputs() {
    ...
    Specification::NetworkUpdateParameters *updateParams = nn->mutable_updateparams();
    Specification::LossLayer *lossLayer = updateParams->add_losslayers();
    lossLayer->set_name("mae_loss_layer");

    Specification::MeanAbsoluteErrorLossLayer *maeLossLayer = lossLayer->mutable_meanabsoluteerrorlosslayer();
    maeLossLayer->set_input("C");
    maeLossLayer->set_target("label_target");
...
int testInvalidHuberLossLayerInputs() {
    ...
    Specification::NetworkUpdateParameters *updateParams = nn->mutable_updateparams();
    Specification::LossLayer *lossLayer = updateParams->add_losslayers();
    lossLayer->set_name("huber_loss_layer");

    Specification::HuberLossLayer *huberLossLayer = lossLayer->mutable_huberlosslayer();
    huberLossLayer->set_input("C");
    huberLossLayer->set_target("label_target");
