...
from coremltools.converters.nnv2.frontend.tensorflow.test.testing_utils import (
    make_tf_graph, tf_graph_to_proto, run_compare_tf
)
# Custom Op imports
...
from coremltools.converters.nnv2.frontend.tensorflow.tf_op_registry import _TF_OPS_REGISTRY
...
class TestCustomMatMul:
    ...
    def SparseMatMul(context, node):
        ...
        x = cb.custom_sparse_matmul(x=a, y=b, transpose_x=transpose_a, transpose_y=transpose_b,
    ...
    def test_tf(self, use_cpu_only, backend, transpose_a, transpose_b,
                 a_is_sparse, b_is_sparse):
        rank = 2
