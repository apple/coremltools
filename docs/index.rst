...
learning models. This specification is defined in `protobuf <https://developers.google.com/protocol-buffers/>`_
and can be created using any language supported by protobuf (e.g., Python, C++, Java, C#, Perl, etc.).
