...
from .tf_graph_pass import insert_get_tuple
from .tf_graph_pass import delete_disconnected_nodes
from .tf_graph_pass import tensor_array_resource_removal
...
def graphdef_to_ssa(graphdef_or_file, main_method_name='main'):
    ...
    tfssa = NetworkEnsemble()
    tfssa.functions[main_method_name] = SSAFunction(gd)
    return tfssa
