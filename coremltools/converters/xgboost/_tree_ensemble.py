...
def _booster_feature_names_workaround(
        model: _xgboost.Booster or _xgboost.XGBRegressor or _xgboost.XGBClassifier, feature_names):
    """
    Removes booster feature names. This is intended as a workaround for faulty JSON dump
    generated by get_dump(dump_format='json') and dumo_model(..., dump_format='json')
    methods in XGBoost.
