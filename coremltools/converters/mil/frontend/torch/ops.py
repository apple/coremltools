...
def _get_inputs(context, node, expected=None, min_expected=None) -> List[Var]:
    ...
    def get_bindings(alist):
        """
        Maps node.inputs -> list of Vars
...
@register_torch_op(torch_alias=["squeeze_copy.dim"])
...
# TODO: tuple output for _native_batch_norm_legit_no_training
# tuple return: line 1810 in
# https://stashweb.sd.apple.com/projects/COREOS/repos/coreml/compare/diff?targetBranch=refs%2Fheads%2Frel%2FDawnburst&sourceBranch=refs%2Fheads%2Fdev%2Fgdawer%2Fprototype-edge-ir&targetRepoId=10024#coremltools/coremltools/converters/mil/frontend/torch/ops.py
# tuple arg: line 211 in
# https://stashweb.sd.apple.com/projects/COREOS/repos/coreml/compare/diff?sourceBranch=refs%2Fheads%2Fdev%2Fgdawer%2Fprototype-edge-ir&targetRepoId=10024#coremltools/coremltools/converters/mil/frontend/torch/ops.py
...
# TODO: make this work for tuple
# tuple return: line 1810 in
# https://stashweb.sd.apple.com/projects/COREOS/repos/coreml/compare/diff?targetBranch=refs%2Fheads%2Frel%2FDawnburst&sourceBranch=refs%2Fheads%2Fdev%2Fgdawer%2Fprototype-edge-ir&targetRepoId=10024#coremltools/coremltools/converters/mil/frontend/torch/ops.py
# tuple arg: line 211 in
# https://stashweb.sd.apple.com/projects/COREOS/repos/coreml/compare/diff?sourceBranch=refs%2Fheads%2Fdev%2Fgdawer%2Fprototype-edge-ir&targetRepoId=10024#coremltools/coremltools/converters/mil/frontend/torch/ops.py
@register_torch_op(torch_alias=["<built-in function getitem>"])
...
def _get_attn_mask(is_causal: bool, attn_mask: Var, query_var: Var, key_var: Var) -> Var:
    if is_causal:
...
@register_torch_op(torch_alias=["_scaled_dot_product_flash_attention"])
