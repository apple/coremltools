...
def make_image_input(model,
    ...
    if spec.WhichOneof("Type") not in ['neuralNetwork', 'neuralNetworkClassifier', 'neuralNetworkRegressor']:
        raise ValueError('Provided model must be of type neuralNetwork, neuralNetworkClassifier or neuralNetworkRegressor')
