...
struct GazetteerDefaultTypeInternal {
  constexpr GazetteerDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT GazetteerDefaultTypeInternal _Gazetteer_default_instance_;
}  // namespace CoreMLModels
}  // namespace Specification
}  // namespace CoreML
namespace CoreML {
...
class Gazetteer::_Internal {
 public:
  static const ::CoreML::Specification::StringVector& stringclasslabels(const Gazetteer* msg);
};

const ::CoreML::Specification::StringVector&
Gazetteer::_Internal::stringclasslabels(const Gazetteer* msg) {
...
Gazetteer::Gazetteer(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
inline void Gazetteer::SharedCtor() {
language_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  language_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void Gazetteer::SharedDtor() {
...
void Gazetteer::ArenaDtor(void* object) {
  Gazetteer* _this = reinterpret_cast< Gazetteer* >(object);
  (void)_this;
}
void Gazetteer::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* Gazetteer::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
uint8_t* Gazetteer::_InternalSerialize(
...
void Gazetteer::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const Gazetteer*>(
      &from));
}
...
template<> PROTOBUF_NOINLINE ::CoreML::Specification::CoreMLModels::Gazetteer* Arena::CreateMaybeMessage< ::CoreML::Specification::CoreMLModels::Gazetteer >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CoreML::Specification::CoreMLModels::Gazetteer >(arena);
}
